...
package projecto_subida.segundojob_0_1;
...
/**
 * Job: SegundoJob Purpose: SegundoJob<br>
 * Description: SegundoJob <br>
 * 
 * @author anndres@devoteam.com
 * @version 7.2.1.20190909_1200_patch
 * @status
 */
public class SegundoJob implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "SegundoJob.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SegundoJob.class);
	...
	private final String jobName = "SegundoJob";
	private final String projectName = "PROJECTO_SUBIDA";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_p5zJEBKnEeqtLo37q-CCNw", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SegundoJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PROJECTO_SUBIDA_SegundoJob = new byte[0];
		static byte[] commonByteArray_PROJECTO_SUBIDA_SegundoJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECTO_SUBIDA_SegundoJob.length) {
					if (length < 1024 && commonByteArray_PROJECTO_SUBIDA_SegundoJob.length == 0) {
						commonByteArray_PROJECTO_SUBIDA_SegundoJob = new byte[1024];
					} else {
						commonByteArray_PROJECTO_SUBIDA_SegundoJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECTO_SUBIDA_SegundoJob, 0, length);
				strReturn = new String(commonByteArray_PROJECTO_SUBIDA_SegundoJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECTO_SUBIDA_SegundoJob) {

				try {

					int length = 0;

					this.Mensaje2 = readString(dis);
...
///////////////////////		
					...
					if (row1.Mensaje2 != null) { //

						strBuffer_tLogRow_1.append(String.valueOf(row1.Mensaje2));
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.addRow(new String[] { "GenreId", "Name", });
...
///////////////////////		
								...
								if (out1.GenreId != null) { //
									row_tLogRow_2[0] = String.valueOf(out1.GenreId);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final SegundoJob SegundoJobClass = new SegundoJob();

		int exitCode = SegundoJobClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'SegundoJob' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'SegundoJob' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = SegundoJob.class.getClassLoader()
					.getResourceAsStream("projecto_subida/segundojob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SegundoJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SegundoJob");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 83367 characters generated by Talend Cloud Big Data on the 2 de diciembre de
 * 2019 10:38:39 CET
 ************************************************************************************************/