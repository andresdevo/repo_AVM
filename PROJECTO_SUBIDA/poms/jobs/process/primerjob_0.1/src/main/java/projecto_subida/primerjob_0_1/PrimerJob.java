...
package projecto_subida.primerjob_0_1;
...
/**
 * Job: PrimerJob Purpose: PrimerJob<br>
 * Description: PrimerJob <br>
 * 
...
public class PrimerJob implements TalendJob {
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_9jhpEBKkEeqtLo37q-CCNw", "0.1");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PROJECTO_SUBIDA_PrimerJob = new byte[0];
		static byte[] commonByteArray_PROJECTO_SUBIDA_PrimerJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECTO_SUBIDA_PrimerJob.length) {
					if (length < 1024 && commonByteArray_PROJECTO_SUBIDA_PrimerJob.length == 0) {
						commonByteArray_PROJECTO_SUBIDA_PrimerJob = new byte[1024];
					} else {
						commonByteArray_PROJECTO_SUBIDA_PrimerJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECTO_SUBIDA_PrimerJob, 0, length);
				strReturn = new String(commonByteArray_PROJECTO_SUBIDA_PrimerJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECTO_SUBIDA_PrimerJob) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = PrimerJob.class.getClassLoader()
					.getResourceAsStream("projecto_subida/primerjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 44206 characters generated by Talend Cloud Big Data on the 29 de noviembre de
 * 2019 13:39:13 CET
 ************************************************************************************************/