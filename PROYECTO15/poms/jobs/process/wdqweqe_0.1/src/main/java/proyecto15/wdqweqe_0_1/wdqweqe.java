...
package proyecto15.wdqweqe_0_1;
 ...
 * @status
 */
public class wdqweqe implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "wdqweqe.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(wdqweqe.class);
	...
	private final String jobName = "wdqweqe";
	private final String projectName = "PROYECTO15";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_hmeYEBUEEeqbh65aDacLVA", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(wdqweqe.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PROYECTO15_wdqweqe = new byte[0];
		static byte[] commonByteArray_PROYECTO15_wdqweqe = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROYECTO15_wdqweqe.length) {
					if (length < 1024 && commonByteArray_PROYECTO15_wdqweqe.length == 0) {
						commonByteArray_PROYECTO15_wdqweqe = new byte[1024];
					} else {
						commonByteArray_PROYECTO15_wdqweqe = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROYECTO15_wdqweqe, 0, length);
				strReturn = new String(commonByteArray_PROYECTO15_wdqweqe, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROYECTO15_wdqweqe) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final wdqweqe wdqweqeClass = new wdqweqe();

		int exitCode = wdqweqeClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'wdqweqe' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'wdqweqe' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = wdqweqe.class.getClassLoader()
					.getResourceAsStream("proyecto15/wdqweqe_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = wdqweqe.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : wdqweqe");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 44068 characters generated by Talend Cloud Big Data on the 2 de diciembre de
 * 2019 14:07:36 CET
 ************************************************************************************************/